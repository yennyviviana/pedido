...
$consulta = "SELECT * FROM carta WHERE plato = '$llave'";
...
<div id="form">
    <form action="routes.php?da=3&lla=<?php echo $llave; ?>" method="post" enctype="multipart/form-data">
        ...
        <input type="text" name="nombre_plato" value="<?php echo $plato['plato']; ?>" required="required" placeholder="Ingresar plato"><br>
...
if (isset($_POST['boton'])) {
    ...
    $editar = "UPDATE carta SET imagen ='$nombrefinal', precio = $precio, ingredientes = '$ingredientes' WHERE plato = '$llave'";
