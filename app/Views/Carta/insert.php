<div id="form">
	...
	<input type="text" name="nombre_plato" required="required" placeholder="Insertar plato"><br>
...
//preguntar si el boton se presiono ----------
	if(isset($_POST['submit'])) {
		...
		$destino = 'imgenes/platos';
		$nombre = $imagen['name'];
		list($nombre_img, $ext_img) = explode('.', $nombre);
		$tamano = $imagen['size'];
		$nombrefinal = $nombre_plato. "_" . $precio. "_".$nombre_img.".".$ext_img;
		/*echo $nombrefinal. "<br>";
		echo $nombre_img. "<br>";
		echo $ext_img. "<br>";*/
		
		//grabo dentro de la base de datos
		$insertar = "INSERT  INTO  carta(nombre_plato, precio, ingredientes, imagen) values('$nombre_plato', $precio, '$ingredientes', '$nombrefinal')";
